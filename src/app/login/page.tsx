...
export default function LoginPage() {
  ...
  const { user, loading: authLoading, signIn, signInWithGoogle, signInWithMagicLink } = useAuth();
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-5">
          ...
          <button
            ...
            disabled={isDisabled}
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-2.5 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-accent focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:ring-offset-background disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
